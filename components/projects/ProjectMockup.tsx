        ...
        <div className="relative bg-gray-900 rounded-t-lg pt-6 px-2 pb-1 shadow-2xl border border-gray-700">
          ...
          <div className="relative w-full aspect-video overflow-hidden rounded-sm">
            {project.image ? (
              ...
              <div className="w-full h-full bg-linear-to-br from-accent/20 via-background-secondary to-accent/10 flex items-center justify-center px-4">
                <span className="text-lg sm:text-xl font-bold text-accent/70 tracking-wide text-center">
                  {project.title}
                </span>
              </div>
            )}
